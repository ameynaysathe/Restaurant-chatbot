...
class RestaurantForm(FormAction):
    ...
    def slot_mappings(self) -> Dict[Text, Union[Dict, List[Dict]]]:
        ...
        #     ],
        # }
        return {"num_people": [self.from_entity(entity="num_people"),
                               self.from_text()],
                "phone_num": [self.from_entity(entity="phone_num"),
                              self.from_text()],
                "time": [self.from_entity(entity="time", intent=["telling_datetime"]),
                         self.from_text()]}
...
class BingLocationExtractor:
    ...
    def __init__(self):
        ...
        self.bing_api_key = "AmLh1M2aXvCGrc3c2AxuqcttZvc2jVTYOvGjjbL7RwM7F-zBVNPEg696TtAlh0Mr"
...
class Zomato:
    ...
    def __init__(self):
        self.api_key = "a7e3c34603ce43509e9f1a1c606c0bc2"
